...
const config: TsudoiConfigFactory = () => {
  return Promise.resolve({
    methods: {
      // COMPLETENESS RULING: INCOMPLETE. Forward the delegate's final list and batches.
      // Paths remain incomplete because further typing can name a new directory.
      // An unavailable document still produces no answer.

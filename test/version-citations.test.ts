...
const accounted: ReadonlyArray<readonly [path: string, runtime: string, version: string]> = [
  ...
  ["packages/tsudoi-completion-document/README.md", "bun", "1.3.13"],
  ["packages/tsudoi-completion-document/README.md", "deno", "2.9.4"],
  ["packages/tsudoi-completion-document/src/scanners.ts", "bun", "1.3.13"],
  ["packages/tsudoi-completion-document/src/scanners.ts", "deno", "2.9.4"],
  ["packages/tsudoi-completion-document/test/scanners.test.ts", "bun", "1.3.13"],
  ["packages/tsudoi-completion-document/test/scanners.test.ts", "deno", "2.9.4"],

...
// import costs the same thing it costs tests/integration/unbuilt-artifact.test.ts: `reRun`
 ...
 * this function made -- the same shape tests/helpers/perturbation.ts uses at

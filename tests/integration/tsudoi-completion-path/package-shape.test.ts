...
const manifest = JSON.parse(
  readFileSync(
    fileURLToPath(
      new URL("../../../packages/tsudoi-completion-path/package.json", import.meta.url),
    ),
    "utf8",
  ),
 ...
 *
 * WHAT TSUDOI'S THIRD ARM COSTS IT, MEASURED: with every dist/
 ...
 * tests/integration/stale-framework-artifact.test.ts stages that pair.
 *

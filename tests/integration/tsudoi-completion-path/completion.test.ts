...
import { tree } from "../../../packages/tsudoi-completion-path/tests/helpers/tree.ts";
...
import {
  ...
  type PathFragment,
  type PathSource,
} from "../../../packages/tsudoi-completion-path/src/completion.ts";
...
// alone can state it.
import { resolvePathStat } from "../../../packages/tsudoi-completion-path/src/resolve.ts";

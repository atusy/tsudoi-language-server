...
/**
 * NOTHING HERE RUNS, for the reason tests/integration/initialize-handler-types.test.ts states
 ...
 *
 * WHAT THIS FILE IS AND WHAT tests/e2e/published-artifacts.test.ts IS, since both
...
/**
 * TSC'S OWN INTERNAL IDENTITY CHECK, spliced from tests/initialize-handler-types

 ...
 * AND NOTHING ELSE.
 *
 * WHY THIS IS NOT tests/integration/workspace-members.test.ts's JOB. That file builds
 ...
 *
 * WHAT IS MEASURED IS ONE STEP AWAY, in tests/integration/package-shape.test.ts, and the
 ...
 * covers src/ and tests/: a probe anywhere else is not in the program its own
 * check reads.
 */

 ...
 * generic negative cases live in tests/integration/artifact-detector.test.ts; this file binds
...
function stageThisCheckout(): { readonly root: string; dispose: () => void } {
  ...
  // is reached -- the same reason tests/helpers/workspace.ts stages what it writes.

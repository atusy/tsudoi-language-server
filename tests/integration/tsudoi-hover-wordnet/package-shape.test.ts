...
const manifest = JSON.parse(
  readFileSync(
    fileURLToPath(new URL("../../../packages/tsudoi-hover-wordnet/package.json", import.meta.url)),
    "utf8",
  ),
 ...
 * tests/integration/stale-framework-artifact.test.ts stages that disagreement over the OTHER

 ...
 * tests/e2e/resolve.test.ts's unrecognised item carries one: a string survives a
...
for (const runtime of runtimes) {
  describe(runtime.name, () => {
     ...
     * executes commands.
     *
     * IT ADDS NO DISCRIMINATION AND IS KEPT ANYWAY. tests/e2e/hover.test.ts drives the same
     ...
     *
     * ITS TWIN OVER THE WHOLE TABLE IS IN tests/e2e/methods-table.test.ts, which this

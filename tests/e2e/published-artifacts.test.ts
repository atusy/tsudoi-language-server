 ...
 *
 * IT IS NOT THE ONLY READER OF THAT TARBALL -- tests/integration/installed-specifier.test.ts
 * and tests/integration/installed-without-node-types.test.ts type-check against the same
 ...
 * dependency layout.
 *
 * The list and the source it builds live in tests/helpers/published-names.ts,
 ...
 * interchangeable here at all: every arm in tests/integration/custom-method-types.test.ts
 ...
 * REPLACED BY IT: tests/integration/packed-members.test.ts reads the tarball, which is where a

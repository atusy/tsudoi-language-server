 ...
 * tests/fixtures/all-methods.ts, one is refused before initialize, one is
...
for (const runtime of runtimes) {
  describe(runtime.name, () => {
     ...
     * tests/fixtures/all-methods.ts's handler for it answering literally
     ...
     * tests/e2e/execute-command.test.ts, and narrowing a published result type to

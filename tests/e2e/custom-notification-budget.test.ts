 ...
 * condition tests/e2e/code-action.test.ts states for its own copy of this line: every
...
for (const runtime of runtimes) {
  describe(runtime.name, () => {
     ...
     *
     * THE PAYLOAD IS JAPANESE for the reason tests/e2e/cli.test.ts gives at its own

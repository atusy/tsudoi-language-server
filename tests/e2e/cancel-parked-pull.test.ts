...
for (const runtime of runtimes) {
  describe(runtime.name, () => {
     ...
     * tests/e2e/cleanup.test.ts holds the permanent control that this measurement can
     ...
     * `a hover cancelled mid-flight ...` in tests/e2e/cancellation.test.ts. That one's

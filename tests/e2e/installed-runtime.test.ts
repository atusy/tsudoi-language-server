 ...
 * -- tests/helpers/install.ts installs whatever .tgz the pack wrote -- so a
 ...
 * `import` from the `./types` arm reddens arms in tests/e2e/published-artifacts.test.ts,
 * tests/integration/package-shape.test.ts, tests/integration/unbuilt-artifact.test.ts and this file.
 *
 ...
 * written -- tests/integration/unbuilt-artifact.test.ts predates them and asserts the arm in

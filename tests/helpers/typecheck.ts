 ...
 * measured by tests/integration/installed-without-node-types.test.ts, which passes its own
 ...
 * helper in tests/integration/package-shape.test.ts records why that makes it the weaker
 ...
 * green half of the pair in tests/integration/probe-routes.test.ts.
 */

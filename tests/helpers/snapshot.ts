...
/**
 * How tests/fixtures/snapshot-config.ts labels its one line on stderr. Exported
...
/**
 * How tests/fixtures/document-members-config.ts labels ITS one line on stderr.
 *

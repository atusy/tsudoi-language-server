 ...
 * own deadline is pinned above, in tests/integration/suite-deadline.test.ts.
 */
...
export const consumers: readonly Consumer[] = [
  ...
  },
  {
    ...
    form: {
      kind: "executed",
      by: "tests/e2e/readme.test.ts runs the documented sequence in a bare stage, under both runtimes, and sweeps each step's omission",
    },
  },
  {
  ...
  },
  {
    ...
    form: {
      kind: "executed",
      by: "tests/e2e/readme.test.ts runs it in the member's own directory and compares the file it wrote against the path the install line names",
    },
  },
  {

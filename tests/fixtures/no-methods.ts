 ...
 * tests/fixtures/hover-absent.ts already gives: a server reading
 ...
 * REASON. That fixture is driven by tests/e2e/hover.test.ts and its block is written
 ...
 *
 * WHAT IT IS FOR: the by-construction assertions in tests/e2e/methods-table.test.ts

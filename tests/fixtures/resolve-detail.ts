...
export default (): Promise<TsudoiConfig> => {
  return Promise.resolve({
    methods: {
      // Resolve requires a completion handler. Missing item details are
      // independent of whether the candidate set is complete.
      ...
      //
      // TOTAL ON PURPOSE: tests/e2e/methods-table.test.ts drives every method in the

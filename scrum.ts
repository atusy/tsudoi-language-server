  ...
  product_backlog: [
    {
      ...
      acceptance_criteria: [
        ...
        },
        {
          ...
          verification:
            "The suite passes WITH NO CHANGE TO THE EXTRACTION MACHINERY. If test/helpers/readme.ts had to be edited, that is REPORTED rather than absorbed: it would mean the rename reached the instrument as well as its subject, and an instrument edited in the same commit as its subject cannot testify about it.",
        },
        {
          criterion:
          ...
          verification:
            "The rename's diff touches no entry under `completed` or `retrospectives`, and ONE note records that the old name is what those entries meant. A sweep that 'helpfully' updates them fails this criterion.",
        },
      ],
      notes: [

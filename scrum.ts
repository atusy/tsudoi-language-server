  ...
  product_backlog: [
    {
      ...
      notes: [
        ...
        "Measured at Review: the shutdown response is emitted for spec-compliant pacing (client awaits it before sending exit) and is LOST if a client pipelines exit without waiting. Spec-defensible and deliberately not defended against, but unpinned by any test -- it can regress silently and the symptom would be an editor hanging on shutdown. Order a regression test at refinement.",

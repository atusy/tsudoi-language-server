...
const scrum: ScrumDashboard = {
  ...
  sprint: {
    ...
    decisions: [
      ...
      "SHIPPED IN ee53bd8..9a53c7e. 413 green from 405, 28 files from 27 -- EIGHT ADDED, NONE REMOVED OR WEAKENED -- each DoD command run separately and unpiped with its exit read directly. FOURTH OF THE STAKEHOLDER'S FIVE METHODS, and the FIRST added through the table rather than by hand: an ENTRY, not a registration.",

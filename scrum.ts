    ...
    subtasks: [
      ...
      },
      {
        ...
        notes: [
          ...
          "AND THE REMAINDER'S OWN ENUMERATION IS WIDER THAN THE PLAN'S SEVEN, ENUMERATED RATHER THAN NAME-GREPPED because a call site can spell its deadline on its own line: TWELVE files set their own. The PO's seven are the BELOW-DEFAULT group, and they are the ones still load-killable at any default this sprint would have chosen -- test/protocol.test.ts 4000, test/session.test.ts 4000, test/completion.test.ts 4000, test/cancel-parked-pull.test.ts 6000, test/cancellation.test.ts 6000, test/cleanup-drain.test.ts 6000, test/cleanup.test.ts 6000 and 18000. AN EIGHTH JOINS THEM THE MOMENT A DEFAULT ABOVE 20_000 IS CHOSEN: test/editor-death.test.ts 20_000, whose 1562ms arm has the LEAST headroom of any gated test in the tree. The remaining four sit at or above any candidate default and are a different class -- test/readme.test.ts 120_000, test/member-resolution.test.ts 120_000, test/workspace-members.test.ts 120_000, test/build-order.test.ts 120_000, test/installed-handler.test.ts 60_000.",
        ],
      },
      {
        test: "None -- prose.",

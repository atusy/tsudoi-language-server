    ...
    subtasks: [
      ...
      },
      {
        ...
        notes: [
          ...
          "AND IT CHANGES WHAT THE FINAL `bun test` MEANS, SAID PLAINLY RATHER THAN AVERAGED AWAY. On a quiet machine this tree ran 741 pass / 0 fail, twice. Under the external load at the end of the session the same tree reports those pre-existing arms timing out. NEITHER NUMBER IS THE HONEST ONE ON ITS OWN: the sprint's own subjects are green in both, and what moves is a set of tests whose only fault is that a compiler took longer than five seconds.",

  ...
  product_backlog: [
    {
      ...
      acceptance_criteria: [
        ...
        {
          criterion:
            "WHAT IS WRITTEN INTO THE BUFFER DOES NOT MOVE: `insertText`, `textEdit.newText` and BOTH ranges are what they were, and the widening-fragment reading of a filename holding a space is untouched. THE FIELDS ARE WHAT THIS CRITERION BINDS, AND THAT IS NARROWER THAN IT FIRST CLAIMED: it said `so no client's insertion changes`, which is a statement about clients and not about this package, and a client computing its own edit from some other field is outside what any of these three can promise.",
          verification:

import { type Bundle, type VerifyOptions, verify as verifyBundle } from "sigstore";
...
export async function verifyProvenance(
  ...
  bundleVerifier: (bundle: Bundle, options: VerifyOptions) => Promise<unknown> = verifyBundle,
): Promise<void> {
